...
Cancel an in-progress multipart upload and cleanup storage resources. Use this endpoint when you need to cancel an upload that won't be completed.
...
- **Cloud Storage**: All uploaded parts are deleted from cloud storage
