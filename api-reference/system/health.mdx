...
The health endpoint provides comprehensive system status information including database connectivity, transcription engine status, R2 storage connectivity, and system cleanup processes.
...
<ResponseField name="services" type="object" required>
  ...
  <Expandable title="Service Details">
    ...
    <ResponseField name="storage" type="ServiceHealth">
      R2 storage connectivity and bucket access
    </ResponseField>
